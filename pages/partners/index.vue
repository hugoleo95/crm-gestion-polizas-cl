<template>
    <div class="pt-1">
      <div class="d-flex  justify-content-between align-items-center">
        <div class="menu-coti d-flex">
          <button
            v-if="$store.state.localStorage.user.role !== 'EXT_KAM' && version === 'MX'"
            :class="[{active:option === 'mudango'}, 'mr-3']"
            style="font-size: 1.15rem"
            @click="option = 'mudango'"
          >
            <fa-icon :icon="['fas', 'shield-alt']" />
            Mundango
          </button>
          <button
            v-if="$store.state.localStorage.user.role !== 'EXT_KAM' && version === 'CL'"
            :class="[{active:option === 'licitalab'}, 'mr-3']"
            style="font-size: 1.15rem"
            @click="option = 'licitalab'"
            >
            <fa-icon :icon="['fas', 'shield-alt']" />
            Licita Lab
            </button>
      ...
      <div v-if="option==='mudango'">
        <Mundango />
      </div>
      <div v-if="option==='licitalab'">
  ...
  import Mundango from '@/components/partners/mudangoList.vue'
