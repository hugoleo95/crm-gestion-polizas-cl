              ...
              <div class="table-wrap">
                <table class="table table-hover table-striped mb-0">
                  ...
                  <tbody>
                    ...
                    >
                      <div
                        class="d-flex flex-fill h-100 loading text-center"
                      >
...
export default {
  ...
  methods: {
    ...
    ModificarContacto (lead) {
      this.$bvModal.msgBoxConfirm('¿Esta seguro de asignar la solicitud a este contacto? el contacto anterior sera eliminado', {
        title: 'Confirmar',
        titleClass: 'mdtitle',
        size: 'md',
        buttonSize: 'md',
        ...
        if (value) {
          this.$emit('UpdateContactEdit', lead)
        }
      })
    },
