            ...
            for (let i = 0; i < rowObject.length; i++) {
              ...
              if (rowObject[i].nro_poliza) {
                ...
                register = {
                  ...
                  razon_social: rowObject[i].contratante,
                  rut: rowObject[i].rut,
                  payment_type: rowObject[i].tipo_de_pago,
                  paid_dues: parseInt(rowObject[i].cuota),
                  total_dues: rowObject[i].cuotas_totales,
                  amount: parseFloat(rowObject[i].monto_cuota),
                  company: rowObject[i].compania,
                  executive: rowObject[i].kam,
                  payment_date: rowObject[i].fecha_de_pago,
                  phone: rowObject[i].telefono_cliente,
                  email: rowObject[i].correo_cliente,
