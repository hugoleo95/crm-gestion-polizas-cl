          ...
          <div class="container">
            <div class="d-flex pt-4 justify-content-between align-items-start flex-row request-title">
              <div class="menu_request d-flex w-75">
                <h2 class="verDocu" @click="openDocument(Quote)">
                  <fa-icon
                    :icon="['fas', 'file']"
                  ...
                  >
                    <div>
                      ...
                      <div class="w-100 d-flex mt-2">
                        <div class="w-50">
                          <h4>
                            Nro del Servicio: {{ GetNroIDServicio(Quote.nro_id_servicio) }}
                          </h4>
                        </div>
                      </div>
                      <div class="w-100 d-flex mt-2 bordertopp">
                        <div class="w-50">
                          <h4>
                            Nombre Completo: {{ Quote.user_full_name }}
                          </h4>
                        </div>
                      </div>
                      <div class="w-100 d-flex mt-2 bordertopp">
                      ...
                      <div class="form-row mtrow">
                        <div class="form-group-request w-50">
                          <span class="text-base w-100 d-flex flex-row">
                            <strong class="pr-1">RCF:</strong>{{ Quote.rfc }}
                           
                          </span>
                        </div>
                        <div class="form-group-request w-50">
                          <span class="text-base w-100 d-flex flex-row">
                            <strong class="pr-1">Email:</strong> {{ Quote.email }}
                          </span>
                        </div>
                      </div>
                      <div class="form-row mtrow">
                        <div class="form-group-request w-50">
                          <span class="text-base w-100 d-flex flex-row">
                            <strong class="pr-1">Teléfono:</strong> {{ Quote.phone }}
                          </span>
                        </div>
                        <div class="form-group-request w-50">
                          <span class="text-base w-100 d-flex flex-row">
                            <strong class="pr-1">
                              Fecha Creacion:</strong> {{ GetDateCreate(Quote.created_at) }}
                          </span>
                        </div>
                      </div>
                      ...
                      <div class="form-row mtrow">
                        <div class="form-group-request w-50">
                          <span class="text-base w-100 d-flex flex-row">
                            <strong class="pr-1">Origen:</strong> {{ Quote.start_location }}
                          </span>
                        </div>
                        <div class="form-group-request w-50">
                          <span class="text-base w-100 d-flex flex-row">
                            <strong class="pr-1">Destino:</strong> {{ Quote.end_location }}
                          </span>
                        </div>
                      </div>
                      <div class="form-row mtrow">
                        <div class="form-group-request w-50">
                          <span class="text-base w-100 d-flex flex-row">
                            <strong class="pr-1">Dia Comienzo:</strong> {{ getDateFormat(Quote.start_day) }}
                            
                          </span>
                        </div>
                        <div class="form-group-request w-50">
                          <span class="text-base w-100 d-flex flex-row">
                            <strong class="pr-1">Dia Final:</strong> {{ getDateFormat(Quote.end_day) }}
                          </span>
                        </div>
                      </div>
                      ...
                      <div class="form-row mtrow">
                        <div class="form-group-request w-50">
                          <span class="text-base w-100 d-flex flex-row">
                            <strong class="pr-1">Nombre de la Compañía de Mudanza:</strong> {{  Quote.moving_company_name }}
                          </span>
                        </div>
                        <div class="form-group-request w-50">
                          <span class="text-base w-100 d-flex flex-row">
                            <strong class="pr-1">Costo del Plan:</strong> {{ getCostoForm(Quote.plan_cost) }}
                          </span>
                        </div>
                      </div>
