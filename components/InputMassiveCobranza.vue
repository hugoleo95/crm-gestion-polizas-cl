            ...
            for (let i = 0; i < rowObject.length; i++) {
              ...
              if (rowObject[i].nro_poliza) {
                ...
                register = {
                  ...
                  payment_date_start: rowObject[i].fecha_inicio_de_pago,
                  dues: rowObject[i].numero_de_cuotas,
                  executive: rowObject[i].usuario,
                  iva_percentage: rowObject[i].iva,
                  amount_dues: rowObject[i].monto_cuotas
